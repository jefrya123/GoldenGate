...
def demo_smart_classification():
    ...
    test_cases = [
        # Phone Numbers - NonControlled vs Controlled
        ...
        # Addresses - NonControlled vs Controlled
        (
            "10 Downing Street, London SW1A 2AA, UK",
            "ADDRESS",
            "UK address → NonControlled",
        ),
        (
            "123 Main Street, Anytown, CA 90210",
            "ADDRESS",
            "Controlled address → Controlled",
        ),
    ]
    ...
    for entity_value, entity_type, description in test_cases:
        classification = classify_label(
            entity_type, entity_value, description, 0, len(entity_value)
        )
    ...
    print("• Phone codes with plus (+XX) automatically detected as NonControlled")
