...
class CustomIDRecognizer(PatternRecognizer):
    ...
    def __init__(self):
        ...
        super().__init__(
            supported_entity="ID", patterns=patterns, supported_language="en"
        )
...
class CustomEINRecognizer(PatternRecognizer):
    ...
    def __init__(self):
        ...
        super().__init__(
            supported_entity="EIN", patterns=patterns, supported_language="en"
        )
...
class CustomZIPRecognizer(PatternRecognizer):
    ...
    def __init__(self):
        patterns = [Pattern("ZIP", r"\b\d{5}(?:-\d{4})?\b", 0.9)]
        super().__init__(
            supported_entity="ZIP", patterns=patterns, supported_language="en"
        )
...
class CustomBankRoutingRecognizer(PatternRecognizer):
    ...
    def __init__(self):
        patterns = [Pattern("BANK_ROUTING", r"\b\d{9}\b", 0.8)]
        super().__init__(
            supported_entity="BANK_ROUTING", patterns=patterns, supported_language="en"
        )
