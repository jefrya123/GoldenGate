...
class UniversalLargeFileScanner:
    ...
    def scan_file(self, file_path: Path, out_dir: Path) -> Dict[str, Any]:
        ...
        print(f"📊 File: {file_info['size_mb']:.1f} MB, Type: {file_info['type']}, Strategy: {file_info['strategy']}")
    ...
    def _analyze_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                if b'\x00' in sample:
                    ...
                    try:
                        ...
                        if file_ext == '.csv' or ',' in text_sample[:1000] and sample_lines > 5:
                            is_structured = True
            ...
            strategy = self._choose_strategy(
                file_size_mb, available_memory_mb, file_ext, 
                is_structured, is_binary, sample_lines
            )
    ...
    def _choose_strategy(self, file_size_mb: float, available_memory_mb: float, 
                        file_ext: str, is_structured: bool, is_binary: bool, 
                        sample_lines: int) -> str:
    ...
    def _scan_csv_streaming(self, file_path: Path, tracker: ProgressTracker, 
    ...
    def _scan_memory_mapped(self, file_path: Path, tracker: ProgressTracker,
                           file_info: Dict) -> Dict[str, Any]:
    ...
    def _scan_chunked_streaming(self, file_path: Path, tracker: ProgressTracker,
                               file_info: Dict) -> Dict[str, Any]:
    ...
    def _scan_parallel_chunks(self, file_path: Path, tracker: ProgressTracker,
                             file_info: Dict) -> Dict[str, Any]:
    ...
    def _scan_standard(self, file_path: Path, tracker: ProgressTracker,
                      file_info: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            all_text = ""
            for text_chunk in extract_text_stream(file_path, file_info.get('optimal_chunk_size', 10000)):
                all_text += text_chunk + "\n"
    ...
    def _collect_futures(self, futures: List, all_entities: List, tracker: ProgressTracker):
    ...
    def _build_result(self, entities: List, tracker: ProgressTracker, 
                     file_info: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            'summary': {
                ...
                'throughput_mb_per_sec': file_info.get('size_mb', 0) / max(stats['elapsed_seconds'], 0.1)
            }
        }